...
export class NguoidungService {
  ...
  SuaThongTinNguoiDung(nguoidung: NguoiDung): Observable<any>{
    let url = `${this.baseUrl}/QuanLyNguoiDung/CapNhatThongTinNguoiDung`;
    return this._http.put(url, nguoidung);
  }
